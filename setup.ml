(* OASIS_START *)
(* DO NOT EDIT (digest: 4ce1b8e74d6411b85461fdecc4e3d9e9) *)
(*
...
let setup_t =
  {
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("markdown", None);
                           FindlibPackage ("markdown.html", None);
                           FindlibPackage ("cameleon.rss", None);
                           FindlibPackage ("sexplib", None);
     ...
     oasis_digest = Some "^\232\2111q\132\205\239\179\176\143[\207g\154R";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
