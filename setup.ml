(* OASIS_START *)
(* DO NOT EDIT (digest: d03023e9c40357f725f0aac124cf2184) *)
(*
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "test";
                      bs_compiled_object = Byte;
                      bs_build_depends = [InternalLibrary "oasis-db"];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "make"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {exec_custom = false; exec_main_is = "FakeIncoming.ml"; });
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      test_tools =
                        [
                           ...
                           InternalExecutable "FakeIncoming"
                        ];
                      });
               Executable
                 ({
                     cs_name = "oasis-server";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "oasis-db-ocsigen";
                           FindlibPackage ("threads", None);
                           FindlibPackage ("ocsigen.ext.staticmod", None);
                           FindlibPackage
                             ("ocsigen.ext.ocsipersist-sqlite", None);
                           FindlibPackage ("ocsigen.ext.eliom", None);
                           FindlibPackage ("ocsigen.ext.staticmod", None);
                           FindlibPackage ("ocsigen.server", None);
                           FindlibPackage ("ocsigen.commandline", None)
                        ];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "make"];
                      bs_c_sources = [];
