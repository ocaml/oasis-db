(* OASIS_START *)
(* DO NOT EDIT (digest: a05b5aa74fe887362cc991eb0a78d62e) *)
(*
     ...
     package =
       {
          ...
          sections =
            [
               Library
                 ({cs_name = "oasis-db"; cs_data = PropList.Data.create (); },
                   {
               ...
               Executable
                 ({cs_name = "inrestart"; cs_data = PropList.Data.create (); 
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Index"; "Account"; "Template"; "SQL"];
                      lib_internal_modules = [];
                          ...
                          Some
                            (OASISVersion.VInt
                               (0,
                                 OASISVersion.VInt
                                   (1,
                                     OASISVersion.VInt (0, OASISVersion.VEnd)))));
