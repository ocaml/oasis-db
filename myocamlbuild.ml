...
(* OASIS_START *)
(* DO NOT EDIT (digest: 69a481dc124378f800f1ee91fe4c4989) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml =
       [
          ("git", ["src/git"]);
          ("rest", ["src/rest"]);
          ("rest-ocsigen", ["src/rest/ocsigen"]);
          ("rest-curl", ["src/rest/curl"]);
          ("oasis-db", ["src/lib"]);
          ("oasis-db-ocsigen", ["src/web"]);
          ("oasis-db-cli", ["src/cli"])
       ];
     lib_c = [];
     flags = [];
     includes =
       [
          ("test", ["src/git"; "src/lib"]);
          ("src/web", ["src/lib"; "src/rest/ocsigen"]);
          ("src/rest/ocsigen", ["src/rest"]);
          ("src/rest/curl", ["src/rest"]);
          ("src/lib", ["src/rest"; "src/rest/curl"]);
          ("src/cli", ["src/lib"])
       ];
     }
  ;;
